package org.pastebin.application.message_db_server.services.aspects;
...
public class MessageServiceAspect {
    @After("execution(public void save(org.pastebin.application.message_db_server.models.MessageTransactionModel))")
