package org.pastebin.application.message_db_server.services.aspects.kafka;
...
public class KafkaSaveListenerAspect {
    @After("execution(public void listenToSave(org.pastebin.application.message_db_server.models.MessageTransactionModel))")
